...
class ReachSceneCfg(InteractiveSceneCfg):
    ...
    #         init_state=RigidObjectCfg.InitialStateCfg(pos=[-0.55, 0.06, 0.755], rot=[0.707, 0, 0.707, 0]),
    #         spawn=UsdFileCfg(
    #             usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Blocks/DexCube/dex_cube_instanceable.usd",
    #             visual_material_path="{ISAAC_NUCLEUS_DIR}/Materialss/Textures/Patterns/nv_steel_corrogated_weatered.jpg",
    #             # usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Shapes/cube.usd",
    ...
    # object2: RigidObjectCfg = RigidObjectCfg(
    #         prim_path="{ENV_REGEX_NS}/Object2",
    #         init_state=RigidObjectCfg.InitialStateCfg(pos=[-0.75, -0.16, 0.755], rot=[0., 0, 0.707, 0.707]),
    #         spawn=UsdFileCfg(
    #             usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Blocks/DexCube/dex_cube_instanceable.usd",
    #             visual_material_path="{ISAAC_NUCLEUS_DIR}/Materialss/Textures/Patterns/nv_steel_corrogated_weatered.jpg",
    #             # usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Shapes/cube.usd",
    ...
    #         ),
    #     )
    # object3: RigidObjectCfg = RigidObjectCfg(
    #         prim_path="{ENV_REGEX_NS}/Object3",
    #         init_state=RigidObjectCfg.InitialStateCfg(pos=[-0.75, 0.30, 0.755], rot=[0., 0, 0.707, 0.707]),
    #         spawn=UsdFileCfg(
    #             usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Blocks/DexCube/dex_cube_instanceable.usd",
    #             visual_material_path="{ISAAC_NUCLEUS_DIR}/Materialss/Textures/Patterns/nv_steel_corrogated_weatered.jpg",
    #             # usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Shapes/cube.usd",
    ...
    #         ),
    #     )
    # object4: RigidObjectCfg = RigidObjectCfg(
    #         prim_path="{ENV_REGEX_NS}/Object4",
    #         init_state=RigidObjectCfg.InitialStateCfg(pos=[-0.90, 0.06, 0.755], rot=[0.707, 0, 0.707, 0]),
    #         spawn=UsdFileCfg(
    #             usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Blocks/DexCube/dex_cube_instanceable.usd",
    #             visual_material_path="{ISAAC_NUCLEUS_DIR}/Materialss/Textures/Patterns/nv_steel_corrogated_weatered.jpg",
    #             # usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Shapes/cube.usd",
    ...
    #         ),
    #     )
    # object5: RigidObjectCfg = RigidObjectCfg(
    #         prim_path="{ENV_REGEX_NS}/Object5",
    #         init_state=RigidObjectCfg.InitialStateCfg(pos=[-0.55, 0.06, 0.355], rot=[0.707, 0, 0.707, 0]),
    #         spawn=UsdFileCfg(
    #             usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Blocks/DexCube/dex_cube_instanceable.usd",
    #             visual_material_path="{ISAAC_NUCLEUS_DIR}/Materialss/Textures/Patterns/nv_steel_corrogated_weatered.jpg",
    #             # usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Shapes/cube.usd",
